...
//                              otherButtonTitles:nil] show];
            ...
            UIAlertController * alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Failure", nil)
                message:NSLocalizedString(@"Out of memory", nil)
...
//        self.view.bounds = CGRectMake(0, 0, frame.size.height, frame.size.height);
