...
class TestViewController: BaseViewController,NSXMLParserDelegate,UITableViewDelegate,UITableViewDataSource,VideoListViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate {
    ...
    func parserDidEndDocument(parser: NSXMLParser) {
        if requestId == NetRequestId.VIDEO_CATEGORY_REQUEST{
            ...
            print(videoPageData.videoList.count)
